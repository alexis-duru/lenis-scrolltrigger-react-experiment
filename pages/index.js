      ...
      <main>
        <div className="frame">
          <div className="frame__title">
            <h1 className="frame__title-main">On Scroll Path Animations</h1>
            <a
        ...
        <section className="content content--centered">
          <div className="content__title">
            ...
            <h2 className="content__title-main">Transcendence</h2>
          </div>
          <div className="content__scroll">Scroll, if you wish</div>
        </section>
        <section className="content">
          <div className="content__bg content__bg--bottom background__one">
            <svg
        ...
        <section class="content">
          <div class="content__bg content__bg--bottom background__three">
            <svg
            ...
            <div class="content__title text-light content__title--right">
              <span class="content__title-pre">Studies of</span>
              <h2 class="content__title-main">Discipline</h2>
            </div>
          </div>
        </section>
        <section class="content content--grid">
          <svg
            class="image-clip content__img"
            width="500px"
            height="750px"
            viewBox="0 0 500 750"
          >
        ...
        <section class="content content--centered">
          <svg
            class="separator separator--solo separator--line"
            viewBox="0 0 900 300"
            width="900"
            height="600"
          >
          ...
          <div class="content__title content__title--right">
            <span class="content__title-pre">Virtues of</span>
            <h2 class="content__title-main">Excellence</h2>
          </div>
          <svg
            class="separator separator--solo separator--line"
            viewBox="0 0 900 300"
        ...
        <section class="content">
          <div class="content__bg content__bg--bottom background__three">
            ...
            <div class="content__title text-light content__title--right">
              <span class="content__title-pre">Language of</span>
              <h2 class="content__title-main">Awekening</h2>
            </div>
          </div>
          <div class="content__stacked">
            <div class="content__interlude">
              <p>TOTO</p>
            </div>
            <svg
              class="image-clip"
            ...
            <svg
              class="image-clip image-clip--offset"
              width="1000px"
              height="715px"
              viewBox="0 0 1000 715"
            >
        ...
        <section class="content footer">
          <div class="content__sides content__sides--nogap">
            <svg
              class="image-clip"
              width="600px"
              height="600px"
            ...
            <div class="content__text content__text--left text-light">
              <h2>Without Longing</h2>
            </div>
          </div>
          <svg
            class="separator separator--solo separator--line-light"
            viewBox="0 0 900 300"
            width="900"
            height="600"
          >
          ...
          <p class="credits">
            Read the{" "}
            <a href="https://tympanus.net/codrops/?p=63809">tutorial</a>.
            Crafted by <a href="https://twitter.com/codrops">@codrops</a>
          </p>
        </section>
      </main>
    </>
